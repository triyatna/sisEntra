...
<body class="loading formulir-sentra-bg authentication-bg-pattern" style="background-image: url(./assets/images/bg-sentra.png);background-size: cover;background-position: center;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="mt-4 text-white">Site is under Maintenance</h2>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="font-13 text-muted mb-0">Currently under repair and feature addition, therefore our website is experiencing downtime for website operation today, please be patient.</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="font-13 text-muted mb-0">Time during which production is stopped especially during setup for an operation or when making repairs.</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="font-13 text-muted mb-0">if you need further information or there are problems, please contact <a href="mailto:marketing@sentrawidyatama.my.id" class="text-muted font-weight-medium">marketing@sentrawidyatama.my.id</a></p>
                                    </div>
                                </div>
