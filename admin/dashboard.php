        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mt-0 mb-4">Member Staff Inti</h4>
                    ...
                    <div class="widget-chart-1">
                        ...
                        <div class="widget-detail-1 text-end">
                            <h2 class="fw-normal pt-2 mb-1">
                                <?php
                                $checkmmbedb = $database->query("SELECT * FROM `users` WHERE `role`='2' OR `role`='3'");
                                $checkmmbedb = $checkmmbedb->rowCount();
                                echo $checkmmbedb;
                                ?> </h2>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="widget-chart-1">
                                ...
                                <div class="widget-detail-1 text-end">
                                    <h2 class="fw-normal pt-2 mb-1"> <?= countDB('sentra_project') ?> </h2>
                                    <p class="text-muted mb-1">Completed by All Division</p>
                                </div>
                            </div>
                        </div>
                    </div>
