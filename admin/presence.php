...
<div class="container-fluid">
    <div class="row">
                        ...
                        <div class="widget-detail-1 text-end">
                            <h2 class="fw-normal pt-2 mb-1">
                                ...
                                if (get('agenda')) {
                                    $agenda = get('agenda');
                                    if ($agenda == 'View All') {
                                        echo $database->query("SELECT * FROM `sentra_presence`")->rowCount();
                                    } else {
                                        echo $database->query("SELECT * FROM `sentra_presence` WHERE `agenda`='$agenda'")->rowCount();
                                    }
                                } else {
                                    echo '0';
                                }
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">Tabel Presensi</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col mb-2">
                        </div>
                    ...
                    <table id="presence-table" class="table table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            if (get('agenda')) {
                                $agenda = get('agenda');
                                if ($agenda == 'View All') {
                                    $ckdbpresens = $database->query("SELECT * FROM `sentra_presence`");
                                } else {
                                    $ckdbpresens = $database->query("SELECT * FROM `sentra_presence` WHERE `agenda`='$agenda'");
                                }
                                $id = 1;
...
<script>
    ...
    page = 'presence';
    document.getElementById("title").innerHTML = "Data Presence | Spanel - Panel BOT Automate sEntra UTama ";
</script>
<?php
